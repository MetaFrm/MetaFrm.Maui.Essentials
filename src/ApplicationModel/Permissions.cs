    ...
    public class Permissions : Maui.ApplicationModel.IPermissions
    {
        ...
        public async Task PermissionsRequestAsync(Maui.ApplicationModel.PermissionType permissionType)
        {
            ...
            switch (permissionType)
            {
                ...
                case Maui.ApplicationModel.PermissionType.PostNotifications: state = await Microsoft.Maui.ApplicationModel.Permissions.CheckStatusAsync<Microsoft.Maui.ApplicationModel.Permissions.PostNotifications>(); break;
                default:
                    return;
            }
            ...
            if (state != PermissionStatus.Granted)
            {
                switch (permissionType)
                {
                    ...
                    case Maui.ApplicationModel.PermissionType.PostNotifications: state = await Microsoft.Maui.ApplicationModel.Permissions.RequestAsync<Microsoft.Maui.ApplicationModel.Permissions.PostNotifications>(); break;
                    default:
                        return;
                }
